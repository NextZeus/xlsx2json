    ...
    if (sheet.data && sheet.data.length > 0) {
        ...
        for (var i_cell = 0; i_cell < row_head.length; i_cell++) {
            ...
            if ((name + '').indexOf('#') != -1) {
                ...
                name = temp[0];
                type = temp[1];
                console.warn('lllllll',type);
                if (type) {
                    type = trim(type);
                    console.warn('mmmmmmm',type);
        ...
        for (var i_row = head; i_row < sheet.maxRow; i_row++) {
            ...
            for (var i_col = 0; i_col < col_type.length; i_col++) {
                ...
                console.warn('ksjdfkjaksjdkfjsd',col_name[i_col],cell.value);
...
function isDateType(value) {
    if (value) {
        //console.warn('11111--->>',moment(value, "YYYY-MM-DD", true).isValid() );
        //console.warn('11111--->>',moment(value, "YYYY-M-D HH:mm:ss", true).isValid());
        //console.warn('11111--->>',moment(value, "YYYY/M/D HH:mm:ss", true).isValid());
        //console.warn('11111--->>',moment(value, "YYYY/MM/DD", true).isValid());


        return moment(value, "YYYY-MM-DD", true).isValid() ||
            moment(value, "YYYY-M-D HH:mm:ss", true).isValid() ||
            moment(value, "YYYY/M/D HH:mm:ss", true).isValid() ||
